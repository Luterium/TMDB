...
import com.example.tmdb.presentation.scene.movieInDetail.DetailedMovieFragment
...
class MainActivity : AppCompatActivity(), MainContract.View,
    ...
    override fun showList(movies: List<Movie>) {
        ...
        val fragmentMovieList =
            MovieListFragment.newInstance(movies as ArrayList<Movie>)
